      ...
      <Card className="w-full max-w-md">
        ...
        <div className="mx-7">
          <div className="flex items-center gap-4 my-4">
            ...
            <span className="text-[10px] font-bold">O regístrate con</span>
            <div className="h-px flex-1 bg-slate-800" />
          </div>
          <div className="mx-2 mt-4">
            <div className="grid grid-cols-2 gap-3">
              <Button
                variant="outline"
                className="flex items-center justify-center py-3 !hover:bg-slate-200 transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
              ...
              <Button
                variant="outline"
                className="flex items-center justify-center gap-3 py-3 !hover:bg-slate-200 transition-colors"
              >
                <Github size={20} />
